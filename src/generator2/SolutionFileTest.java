...
class SolutionFileTest {
    ...
    void testNotEmptyMarkdownFile() {
        SolutionFile res = SolutionFile.parseFile(MD_NON_EMPTY_FILE, Application.FileType.MARKDOWN, "output");
        List<ItemEntity> lst = List.of(new MarkdownEntity(MD_TITLE, MD_URL, MD_SOLUTION));
        SolutionFile expect = new SolutionFile(lst, Application.FileType.MARKDOWN, "output");
        assertEquals(expect, res);
    }

    @Test
    void testEmptyMarkdownFile() {
        SolutionFile res = SolutionFile.parseFile(MD_EMPTY_FILE_CONTENT, Application.FileType.MARKDOWN, "output");
    ...
    void testToMarkdownString() {
        SolutionFile result = SolutionFile.parseFile(MD_NON_EMPTY_FILE, Application.FileType.MARKDOWN, "output");
