...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        String source = "C:\\Users\\Александр\\IdeaProjects\\java_au\\src\\generator2\\stream.md";
        List<String> newContent = IOUtil.readData(userSource);
        List<String> oldContent = IOUtil.readData(source);

        IOUtil.writeData(source, Generator.generateContent(oldContent, newContent, FileType.MARKDOWN, "stream"));
    }
}
